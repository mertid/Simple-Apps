...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        listItems = [@[@"Bob",@"Jeff",@"Addy"]mutableCopy];
    }
    return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString * name = listItems[indexPath.row];
...
{
    TDAViewController * addVC = [segue destinationViewController];
    
    addVC.listItems = listItems;
